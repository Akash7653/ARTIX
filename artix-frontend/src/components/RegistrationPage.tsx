      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        ...
        <div className="mb-16 px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className={`group relative overflow-hidden rounded-3xl transition-all duration-300 ${
              darkMode
                ? 'bg-gradient-to-br from-blue-900/40 via-blue-800/30 to-indigo-900/40 border-2 border-blue-600/50'
                : 'bg-gradient-to-br from-blue-100/60 via-blue-50/50 to-indigo-100/40 border-2 border-blue-400/50'
            } backdrop-blur-md overflow-hidden shadow-2xl hover:shadow-blue-500/50 hover:scale-105`}>
            ...
            {/* Guest 2: Dodla Megha - Premium Invitation Card */}
            <div className={`group relative overflow-hidden rounded-3xl transition-all duration-300 ${
              darkMode
                ? 'bg-gradient-to-br from-purple-900/40 via-purple-800/30 to-pink-900/40 border-2 border-purple-600/50'
                : 'bg-gradient-to-br from-purple-100/60 via-purple-50/50 to-pink-100/40 border-2 border-purple-400/50'
            } backdrop-blur-md overflow-hidden shadow-2xl hover:shadow-purple-500/50 hover:scale-105`}>
              <div className={`absolute inset-0 ${
                darkMode 
                  ? 'bg-gradient-to-r from-purple-500/0 via-purple-500/10 to-pink-500/0' 
                  : 'bg-gradient-to-r from-purple-400/0 via-purple-400/15 to-pink-400/0'
              }`}></div>
              ...
              <div className="relative z-10 py-10 px-6">
                ...
                <div className="flex justify-center mb-6">
                  <div className={`w-36 h-36 rounded-full overflow-hidden border-4 ${
                    darkMode ? 'border-purple-500/70' : 'border-purple-600/70'
                  } shadow-xl group-hover:scale-110 transition-transform duration-300 relative`}>
                    <img 
            ...
            {/* Guest 3: Deepak Mourya - Premium Invitation Card */}
            <div className={`group relative overflow-hidden rounded-3xl transition-all duration-300 ${
              darkMode
                ? 'bg-gradient-to-br from-cyan-900/40 via-cyan-800/30 to-teal-900/40 border-2 border-cyan-600/50'
                : 'bg-gradient-to-br from-cyan-100/60 via-cyan-50/50 to-teal-100/40 border-2 border-cyan-400/50'
            } backdrop-blur-md overflow-hidden shadow-2xl hover:shadow-cyan-500/50 hover:scale-105`}>
              <div className={`absolute inset-0 ${
                darkMode 
                  ? 'bg-gradient-to-r from-cyan-500/0 via-cyan-500/10 to-teal-500/0' 
                  : 'bg-gradient-to-r from-cyan-400/0 via-cyan-400/15 to-teal-400/0'
              }`}></div>
              ...
              <div className="relative z-10 py-10 px-6">
                ...
                <div className="flex justify-center mb-6">
                  <div className={`w-36 h-36 rounded-full overflow-hidden border-4 ${
                    darkMode ? 'border-cyan-500/70' : 'border-cyan-600/70'
                  } shadow-xl group-hover:scale-110 transition-transform duration-300 relative`}>
                    <img 
                    ...
                    <div className={`absolute inset-0 ${
                      darkMode 
                        ? 'bg-gradient-to-t from-cyan-900/40 to-transparent' 
        ...
        <div className="flex flex-row gap-6 sm:gap-8 md:gap-10 justify-center items-center px-2 md:px-0 pb-8 md:pb-0 flex-wrap">
          ...
          <a 
            ...
            className={`min-w-fit sm:flex-none inline-flex items-center justify-center gap-1 sm:gap-2 px-1.5 sm:px-4 md:px-8 lg:px-10 py-4 sm:py-5 md:py-6 lg:py-7 text-sm sm:text-lg md:text-xl lg:text-2xl font-bold rounded-full transition-all duration-300 hover:scale-110 shadow-xl ${
              darkMode
